...
function All_Course() {
  ...
  useEffect(() => {
    axios("https://63547f47e64783fa8285a355.mockapi.io//Course").then((res) => {
    ...
    >
      ...
      <div className="container align-items-center text-center ">
        ...
        <div className="row row-cols-1 row-cols-md-3 g-5 mb-4 align-items-center ">
          {allCourse.map((el) => (
            <div className="col hover-zoom" key={el.id}>
              <div className="card h-100 bg-light" id="editCard">
                <img src={el.Img} className="card-img-top" id="cardimg" alt="..." />
